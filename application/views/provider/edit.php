...
<div class="container-fluid">
    <section id="main-content" class="">
      <section class="wrapper">
        ...
        <h3><i class="fa fa-angle-right"></i> <?= $sub_title." : ".$provider['name_prov'] ; ?></h3>
      ...
      <div class="row mt container-fluid" style="margin-bottom: 101px">
        <div class="col-lg-12 content-panel" style="">
          ...
          <form class="cmxform form-horizontal style-form" id="commentForm" method="post" 
                action="<?= site_url('admin/C_Provider/update'); ?>" enctype="multipart/form-data"/>
            <div class="col-lg-5 col-md-5">

              <input type="hidden" name="id_prov" value="<?= $provider['id_prov']; ?>">
              
              <div class="form-group ">
                <label for="name_prov" class="control-label col-lg-4">Partenaire : </label>
                <div class="col-lg-8">
                  <input type="text" name="name_prov" id="name_prov" class="form-control" value="<?= (!empty(set_value('name_prov')) ? set_value('name_prov') : $provider['name_prov']);?>">
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                  ...
                  <input type="text" name="social_reason" id="social_reason" class="form-control" value="<?= (!empty(set_value('social_reason')) ? set_value('social_reason') : $provider['social_reason']);?>">
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                  ...
                  <input type="text" name="contact" id="contact" class="form-control" value="<?= (!empty(set_value('contact')) ? set_value('contact') : $provider['contact']);?>" style="padding: 0px; padding-left: 4px">
              ...
              <div class="form-group ">
                <label for="description" class="control-label col-lg-4">Description <span style="color: red">* </span>: </label>

                <div class="col-lg-12 compose-editor">
                  <textarea  class="wysihtml5 form-control" rows="9" value="<?=(!empty(set_value('description')) ? set_value('description') : $provider['description']);?>" name="description">
                    
                    <?=(!empty(set_value('description')) ? set_value('description') : $provider['description']);?>
            ...
            <div class="col-lg-2 col-md-2">
              ...
              <div class="form-group">
                  <label for="date_reg_prov" class="control-label">Date de modification</label>
                  <div class="col-lg-10">
                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2000" class="input-append date dpYears">
                      <input id="date_reg_prov" name="date_reg_prov" type="text" readonly="" value="<?= !empty(set_value('date_reg_prov')) ? date("d-m-Y", strtotime(set_value('date_reg_prov'))) : '01-01-2000'; ?>" size="16" class="form-control">
            ...
            <div class="col-lg-5 col-md-5">
              ...
              <div class="col-lg-8">
                ...
                <input type="text" name="code_number" id="code_number" class="form-control" value="<?= (!empty(set_value('code_number')) ? set_value('code_number') : $provider['code_number']);?>">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-12 compose-editor">
                  <textarea name="termes" id="termes" class="wysihtml5 form-control" rows="9"
                     value="<?=(!empty(set_value('termes')) ? set_value('termes') : $provider['termes']);?>">
                     <?=(!empty(set_value('termes')) ? set_value('termes') : $provider['termes']);?>
