      ...
      <section class="wrapper">
       ...
       <!-- FORM VALIDATION -->
          ...
          <form class="cmxform form-horizontal style-form" id="commentForm" method="post" 
                action="<?= base_url('admin/ControlPanel/addThisMat/'); ?>" enctype="multipart/form-data"/>
            <div class="col-lg-4 col-md-4">
              
              <div class="form-group ">
                <label for="name_mat" class="control-label col-lg-4">Désignation <span style="color: red">*</span> :</label>
                <div class="col-lg-8">
                    <?= form_input(['name' => "name_mat", 'id' => "name_mat", 'class' => 'form-control', 'style' => ";"], set_value('name_mat')) ?>
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                    <?= form_input(['name' => "reg_num_mat", 'id' => "reg_num_mat", 'class' => 'form-control', 'style' => ";"], set_value('reg_num_mat')) ?>
            ...
            <div class="col-lg-5 col-md-5">
              <div class="form-group ">
                ...
                <div class="col-lg-12 compose-editor">
                  <textarea  class="wysihtml5 form-control" rows="9" value="<?= set_value('desc_mat'); ?>" name="desc_mat" id="desc_mat" class="form-control"
                    ><?= set_value('desc_mat'); ?>
