            ...
            <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="<?= base_url('admin/ControlPanel/updateCus'); ?>" enctype="multipart/form-data"/>
              <div class="col-lg-5 col-md-5">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-8">
                    <input type="text" name="fname_cost" id="fname_cost" class="form-control" value="<?= (!empty(set_value('fname_cost')) ? set_value('fname_cost') : $thisCus->fname_cost) ?>">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-8">
                    <input type="text" name="sname_cost" id="sname_cost" class="form-control" value="<?= (!empty(set_value('sname_cost')) ? set_value('sname_cost') : $thisCus->sname_cost);?>">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-8">
                    <input type="password" name="password" id="password" class="form-control" value="<?= (!empty(set_value('password')) ? set_value('password') : "");?>">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-8">
                    <input type="password" name="cpassword" id="cpassword" class="form-control" value="<?= (!empty(set_value('cpassword')) ? set_value('cpassword') : "");?>">
                ...
                <div class="form-group last">
                  <div class="col-md-12">
                    ...
                    <select name="genre" id="genre" class="form-control">
                      ...
                      <option value="0" <?= ($thisCus->genre == 0) ? ' selected="selected"' : '' ; ?>>
                        FEMININ
                      </option>
              ...
              <div class="col-lg-5 col-md-5">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-4">
                    <input type="phone" name="phone" id="phone" class="form-control" value="<?= (!empty(set_value('phone')) ? set_value('phone') : $thisCus->phone);?>">
