      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div id="message"></div>
            <form class="contact-form php-mail-form" role="form" action="<?= site_url('admin/ControlPublic/answer') ?>" method="POST">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <h4 class="title">Message en réponse</h4>
        ...
        <?php if(!isset($this_issue)): ?>
          <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <form class="contact-form php-mail-form" role="form" action="<?= site_url('admin/ControlPublic/updContactPage') ?>" method="POST">
              <textarea class="wysihtml5" rows="8" cols="80" name="comment" style="padding: 4px">
                <?= $index_com_contact->descrip; ?>
              </textarea>
              <ul class="contact_details">
              ...
              <!-- contact_details -->
              <div class="form-send">
                <button type="submit" class="btn btn-large btn-primary" style="border-radius: 0px"><i class="glyphicon glyphicon-refresh"></i> Modier</button>
              </div>
            </form>
          </div>
        <?php endif; ?>
        ...
        <!-- page start-->
          <hr>
          <h4 class="title">Liste des échanges</h4>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th style="width: %">Personnel / Client / Abonné</th>
                ...
                <?php foreach ($messages->result_array() as $message): ?>
                  ...
                  <tr class="
                    ...
                    <td style="text-align: center;">
                      <a href="<?= base_url('admin/ControlPublic/Contactform/'.$message['id_issue']);?>" style="margin: 2%; border-radius: 4px; font-size: 17px;" class="btn btn-info btn-xs" title='Répondre'>
                        <?= $message['state_msg'] == 1 ? '<i class="glyphicon glyphicon-refresh"></i>' : '' ?>
