      ...
      <!-- FORM VALIDATION -->
        ...
        <div class="col-lg-12 content-panel" style="">
          <form class="cmxform form-horizontal style-form" id="commentForm" method="post" 
                action="<?= base_url('admin/ControlPanel/updRea/'); ?>" enctype="multipart/form-data"/>
            <div class="col-lg-5 col-md-5">
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                    <?= form_input(['name' => "name_reason", 'id' => "name_reason", 'class' => 'form-control'], (is_null(set_value('name_reason')) ? set_value('name_reason') : $thisReason->name_reason)) ?>
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                    <?= form_input(['name' => "code_reason", 'id' => "code_reason", 'class' => 'form-control'], (is_null(set_value('code_reason')) ? set_value('code_reason') : $thisReason->code_reason)) ?>
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                    <?= form_input(['name' => "origine_reason", 'id' => "origine_reason", 'class' => 'form-control', 'style' => ";"],  (is_null(set_value('origine_reason')) ? set_value('origine_reason') : $thisReason->origine_reason)) ?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6" style="width: 65%">
                  ...
                  <select name="id_cat_reason" id="id_cat_reason" class="form-control">
                    ...
                    <?php 
                      $selected = '';
                      if ($sub_categorie['id_sub_cat'] == $thisReason->id_sub_cat ) {
                        $selected = 'selected="selected"';
                      }

                    ?>
                    <option value="<?= $sub_categorie['id_sub_cat']; ?>" <?= $selected; ?>>
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-12 compose-editor">
                  <textarea  class="wysihtml5 form-control" rows="9" name="description_reason" id="description_reason" class="form-control">
                    <?= (is_null(set_value('description_reason')) ? set_value('description_reason') : $thisReason->description_reason);?>
            ...
            <div class="col-lg-5 col-md-5">
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                      <?= form_input(['name' => "price_reason", 'id' => "price_reason", 'class' => 'form-control', 'type' => "number", 'step' => "0.01"], (is_null(set_value('price_reason')) ? set_value('price_reason') : $thisReason->price_reason)); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <?= form_input(['name' => "old_price", 'id' => "old_price", 'class' => 'form-control', 'type' => "number", 'step' => "0.01"], (!empty(set_value('old_price')) ? set_value('old_price') : $thisReason->old_price)) ?>
                  ...
                  <div class="col-lg-8">
                    ...
                    <select name="type_reason" id="type_reason" class="form-control">
                      ...
                      <?php 
                        ...
                        if (!empty(set_value('type_reason')) and set_value('type_reason') != $thisReason->type_reason) {
                          $selected = 'selected="selected"';
                        }
                        elseif ($type_reason['id_type'] == $thisReason->type_reason ) {
                          
                          $selected = 'selected="selected"';
                        }

                      ?>
                      <option value="<?= $type_reason['id_type']; ?>" <?= $selected; ?>>
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="input-group input-large" data-date="01-01-2000" data-date-format="mm-dd-yyyy">
                      <input type="text" class="form-control dpd1" name="date_manufacturate" value="<?= (is_null(set_value('date_manufacturate')) ? set_value('date_manufacturate') : (is_null($thisReason->date_manufacturate) or $thisReason->date_manufacturate)=='0000-00-00' ? '01/01/2021' : $thisReason->date_manufacturate); ?>">
                      <span class="input-group-addon">à</span>
                      <input type="text" class="form-control dpd2" name="date_experation" value="<?= (is_null(set_value('date_experation')) ? set_value('date_experation') : (is_null($thisReason->date_experation) or $thisReason->date_experation)=='0000-00-00' ? '01/01/2021' : $thisReason->date_experation); ?>">
                    </div>
                ...
                <div class="form-group compose-editor">
                  ...
                  <textarea  class="wysihtml5 form-control" rows="9" value="<?= (is_null(set_value('note_reason')) ? set_value('note_reason') : $thisReason->note_reason); ?>" name="note_reason" id="note_reason"
                    ><?= (is_null(set_value('note_reason')) ? set_value('note_reason') : $thisReason->note_reason); ?>
            ...
            <div class="col-lg-2 col-md-2">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                  ...
                  <div>
                    ...
                    <input type="file" name="userimage" id="userimage" class="default" title="choisissez une image qui servira de présentation du produit / service." value="<?= !empty(set_value('userimage')) ? set_value('userimage') : $thisReason->img_reason;?>" />
                    </span>
                  </div>
                  <?= !empty(set_value('userimage')) ? set_value('userimage') : $thisReason->img_reason;?>

                  <div class="<?= empty(form_error('userimage')) ? '' : "has-error" ?>">
                    <br><span class="help-block "><?= form_error('userimage'); ?></span >
                  </div>
                  <?= !empty(set_value('userimage')) ? set_value('userimage') : '';?>
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                  ...
                  <div>
                    ...
                    <span class="fileupload-exists"><i class="fa fa-undo" style="border-radius: 0px"></i> Changer</span>
                    <input type="file" name="userfile" id="userfile" class="default" title="choisissez une image qui affichera plus de vues du produit / service." value="<?= !empty(set_value('userfile')) ? set_value('userfile') :  $thisReason->img2_reason;?>" />
                    </span>
                  </div>
                  <?= !empty(set_value('userfile')) ? set_value('userfile') : $thisReason->img2_reason;?>
